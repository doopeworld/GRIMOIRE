...
icpx "${COMMON[@]}" src/xe2_grouped_bridge.cpp -o /tmp/libdense_tune.so -lze_loader
icpx -O3 -std=c++17 -fsycl tools/autotune_b70_dense.cpp /tmp/libdense_tune.so \
 -Wl,-rpath,/tmp -o /tmp/autotune_b70_dense
/tmp/autotune_b70_dense
